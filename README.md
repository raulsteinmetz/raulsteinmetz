...
Welcome to my GitHub profile! I'm Raul Steinmetz, a passionate Deep Learning Researcher with a focus on innovative solutions in Machine Learning, Deep Reinforcement Learning, and Computer Vision.

#### About Me

- **Portfolio:** Check out my work and insights at [rsteinmetz.com](https://www.rsteinmetz.com/).
- **Project Highlight:** Lead maintainer of [ufsm-map](https://ufsm-map.onrender.com/) - a dynamic university map powered by user contributions.
- **Current Learning:** Deepening my expertise in Deep Learning, Deep Reinforcement Learning, and Computer Vision.
- **Discussion Topics:** Feel free to ask about Machine Learning, Deep Learning, Computer Vision, and Image Processing.
- **Contact Me:** Reach out via email at [rsteinmetz@inf.ufsm.br](mailto:rsteinmetz@inf.ufsm.br).
